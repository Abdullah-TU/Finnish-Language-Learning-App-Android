...
@SuppressLint("NewApi")
public class NumberText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.numbertext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(NumberText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Hundred");
        option2.setText("Thousand");
        option3.setText("Million");
        option4.setText("Eleven");
        option5.setText("Twentyone");
