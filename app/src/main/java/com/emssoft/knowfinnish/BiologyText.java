...
@SuppressLint("NewApi")
public class BiologyText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.biologytext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(BiologyText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Biology");
        option2.setText("Animal");
        option3.setText("Parasite");
        option4.setText("Vaccine");
        option5.setText("Cell");
