...
@SuppressLint("NewApi")
public class FamilyText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.familytext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(FamilyText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Father");
        option2.setText("Mother");
        option3.setText("Brother");
        option4.setText("Sister");
        option5.setText("Family");
