...
@SuppressLint("NewApi")
public class SportText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sporttext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(SportText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Football");
        option2.setText("Hunting");
        option3.setText("Shooting");
        option4.setText("Cycling");
        option5.setText("Fishing");
