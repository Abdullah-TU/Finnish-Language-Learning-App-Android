...
@SuppressLint("NewApi")
public class EnvironmentText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.environmenttext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(EnvironmentText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Foggy");
        option2.setText("Hot");
        option3.setText("Storm");
        option4.setText("Sun");
        option5.setText("Windy");
