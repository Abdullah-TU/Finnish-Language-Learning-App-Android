...
public class HomeCard extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.homecard);
    ...
    findViewById(R.id.imgFrontCard).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Toast.makeText(HomeCard.this, "Front Card", Toast.LENGTH_SHORT).show();
    ...
    findViewById(R.id.imgBackCard).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Toast.makeText(HomeCard.this, "Back Card", Toast.LENGTH_SHORT).show();
        easyFlipView.flipTheView();
      }
    });
