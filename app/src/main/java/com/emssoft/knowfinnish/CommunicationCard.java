...
public class CommunicationCard extends AppCompatActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.communicationcard);
    ...
    findViewById(R.id.imgFrontCard).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Toast.makeText(CommunicationCard.this, "Front Card", Toast.LENGTH_SHORT).show();
    ...
    findViewById(R.id.imgBackCard).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Toast.makeText(CommunicationCard.this, "Back Card", Toast.LENGTH_SHORT).show();
        easyFlipView.flipTheView();
      }
    });
    ...
    easyFlipView.setOnFlipListener(new EasyFlipView.OnFlipAnimationListener() {
      ...
      public void onViewFlipCompleted(EasyFlipView easyView, EasyFlipView.FlipState newCurrentSide) {
        Toast.makeText(CommunicationCard.this,
