...
@SuppressLint("NewApi")
public class EnvironmentImage  extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.environmentimage);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(EnvironmentImage.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
