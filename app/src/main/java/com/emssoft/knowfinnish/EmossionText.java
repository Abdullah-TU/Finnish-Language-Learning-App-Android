...
@SuppressLint("NewApi")
public class EmossionText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.emossiontext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(EmossionText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Be careful");
        option2.setText("Be quiet");
        option3.setText("Shut up");
        option4.setText("Stop it");
        option5.setText("Are you sure?");
