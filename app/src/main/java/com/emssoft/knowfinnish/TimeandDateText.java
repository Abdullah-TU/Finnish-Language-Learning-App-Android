...
@SuppressLint("NewApi")
public class TimeandDateText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tanddtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(TimeandDateText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("What time it is now?");
        option2.setText("It is one o'clock");
        option3.setText("Holiday");
        option4.setText("Weekdays");
        option5.setText("Yesterday");
