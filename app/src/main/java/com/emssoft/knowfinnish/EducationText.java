...
@SuppressLint("NewApi")
public class EducationText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.educationtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(EducationText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Education");
        option2.setText("Kynä");
        option3.setText("University");
        option4.setText("Teacher");
        option5.setText("Dictionary");
