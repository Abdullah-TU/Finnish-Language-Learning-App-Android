...
@SuppressLint("NewApi")
public class FoodText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.foodtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(FoodText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Bean");
        option2.setText("Potato");
        option3.setText("Beef");
        option4.setText("Burger");
        option5.setText("Salad");
