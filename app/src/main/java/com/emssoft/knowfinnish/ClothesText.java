...
@SuppressLint("NewApi")
public class ClothesText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.clothestext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(ClothesText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Shirt");
        option2.setText("Shoes");
        option3.setText("Skirt");
        option4.setText("Jeans");
        option5.setText("Leather");
