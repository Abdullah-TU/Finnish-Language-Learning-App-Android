...
@SuppressLint("NewApi")
public class ComputerText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.computertext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(ComputerText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Desktop computer");
        option2.setText("Scanner");
        option3.setText("Operating system");
        option4.setText("Keyboard");
        option5.setText("Memory card");
