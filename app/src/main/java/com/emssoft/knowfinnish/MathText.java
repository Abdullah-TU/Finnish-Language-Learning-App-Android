...
@SuppressLint("NewApi")
public class MathText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mathtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(MathText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Circle");
        option2.setText("Triangle");
        option3.setText("Square");
        option4.setText("Calculator");
        option5.setText("Subtraction");
