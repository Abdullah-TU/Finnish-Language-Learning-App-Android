...
public class EducationCard extends AppCompatActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.educationcard);
    ...
    findViewById(R.id.imgFrontCard).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Toast.makeText(EducationCard.this, "Front Card", Toast.LENGTH_SHORT).show();
    ...
    findViewById(R.id.imgBackCard).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Toast.makeText(EducationCard.this, "Back Card", Toast.LENGTH_SHORT).show();
        easyFlipView.flipTheView();
      }
    });
    ...
    easyFlipView.setOnFlipListener(new EasyFlipView.OnFlipAnimationListener() {
      ...
      public void onViewFlipCompleted(EasyFlipView easyView, EasyFlipView.FlipState newCurrentSide) {
        Toast.makeText(EducationCard.this,
