...
@SuppressLint("NewApi")
public class TransportText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.transporttext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(TransportText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    public void reset(View view)
    {
        ...
        option2.setText("Taxi");
        option3.setText("Airplane");
        option4.setText("Metro");
        option5.setText("Tram");
