...
public class ColorText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.colortext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(ColorText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    public void reset(View view)
    {
        ...
        option3.setText("Purple");
        option4.setText("Blue");
        option5.setText("Color");
