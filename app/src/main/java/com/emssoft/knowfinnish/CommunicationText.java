...
@SuppressLint("NewApi")
public class CommunicationText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.communicationtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(CommunicationText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Conversation");
        option2.setText("To ask");
        option3.setText("To command");
        option4.setText("To invite");
        option5.setText("To speak");
