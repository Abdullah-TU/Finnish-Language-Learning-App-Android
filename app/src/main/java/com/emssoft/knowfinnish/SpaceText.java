...
@SuppressLint("NewApi")
public class SpaceText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.spacetext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(SpaceText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Planet");
        option2.setText("Sun");
        option3.setText("Moon");
        option4.setText("Galaxy");
        option5.setText("Atmosphere");
