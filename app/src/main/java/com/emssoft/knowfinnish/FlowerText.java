...
@SuppressLint("NewApi")
public class FlowerText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.flowertext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(FlowerText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Sun flower");
        option2.setText("Dahlia");
        option3.setText("Water lily");
        option4.setText("Orchid");
        option5.setText("Tulip");
