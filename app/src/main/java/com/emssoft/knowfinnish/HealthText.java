...
@SuppressLint("NewApi")
public class HealthText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.healthtext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(HealthText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Physiotherapist");
        option2.setText("Disease");
        option3.setText("Fever");
        option4.setText("Pharmacy");
        option5.setText("Surgery");
