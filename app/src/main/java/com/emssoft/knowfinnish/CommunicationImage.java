...
@SuppressLint("NewApi")
public class CommunicationImage extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.communicationimage);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(CommunicationImage.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
