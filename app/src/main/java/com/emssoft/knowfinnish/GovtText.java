...
@SuppressLint("NewApi")
public class GovtText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.govttext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(GovtText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Prime minister");
        option2.setText("Democracy");
        option3.setText("Society");
        option4.setText("Candidate");
        option5.setText("Nation");
