...
@SuppressLint("NewApi")
public class AnimalText extends Activity {
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(AnimalText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Bird");
        option2.setText("Duck");
        option3.setText("Rat");
        option4.setText("Rabbit");
        option5.setText("Tiger");
