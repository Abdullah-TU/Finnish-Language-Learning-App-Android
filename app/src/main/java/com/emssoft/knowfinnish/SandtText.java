...
@SuppressLint("NewApi")
public class SandtText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sandttext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(SandtText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Automation");
        option2.setText("Business");
        option3.setText("Computer");
        option4.setText("Forestry");
        option5.setText("Mobile");
