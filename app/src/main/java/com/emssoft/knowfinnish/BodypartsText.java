...
@SuppressLint("NewApi")
public class BodypartsText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bodypartstext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(BodypartsText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Mouth");
        option2.setText("Finger");
        option3.setText("Hair ");
        option4.setText("Teeth");
        option5.setText("Stomach ");
