...
public class MathCard extends AppCompatActivity {

  @Override
  protected void onCreate(Bundle savedInstanceState) {
    super.onCreate(savedInstanceState);
    setContentView(R.layout.mathcard);
    ...
    findViewById(R.id.imgFrontCard).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Toast.makeText(MathCard.this, "Front Card", Toast.LENGTH_SHORT).show();
    ...
    findViewById(R.id.imgBackCard).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Toast.makeText(MathCard.this, "Back Card", Toast.LENGTH_SHORT).show();
        easyFlipView.flipTheView();
      }
    });
