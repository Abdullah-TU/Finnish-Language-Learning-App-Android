...
public class HealthCard extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.healthcard);
    ...
    findViewById(R.id.imgFrontCard).setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
        Toast.makeText(HealthCard.this, "Front Card", Toast.LENGTH_SHORT).show();
    ...
    findViewById(R.id.imgBackCard).setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View view) {
        Toast.makeText(HealthCard.this, "Back Card", Toast.LENGTH_SHORT).show();
        easyFlipView.flipTheView();
      }
    });
    ...
    easyFlipView.setOnFlipListener(new EasyFlipView.OnFlipAnimationListener() {
      ...
      public void onViewFlipCompleted(EasyFlipView easyView, EasyFlipView.FlipState newCurrentSide) {
        Toast.makeText(HealthCard.this,
