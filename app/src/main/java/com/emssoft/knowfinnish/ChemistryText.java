...
@SuppressLint("NewApi")
public class ChemistryText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chemistrytext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(ChemistryText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Reaction");
        option2.setText("Oxigen");
        option3.setText("Nitrogen");
        option4.setText("Carbon");
        option5.setText("Molecule");
