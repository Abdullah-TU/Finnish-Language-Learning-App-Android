...
@SuppressLint("NewApi")
public class ReligionText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.religiontext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(ReligionText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    {
        option1.setText("Jumala");
        option2.setText("Piru");
        option3.setText("Taivas");
        option4.setText("Helvetti");
        option5.setText("Ateisti");
