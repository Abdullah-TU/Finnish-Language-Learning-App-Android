...
@SuppressLint("NewApi")
public class FruitsText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fruitstext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText( FruitsText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    public void reset(View view)
    {
        ...
        option3.setText("Pineapple");
        option4.setText("Raspberry");
        option5.setText("Strawberry");
