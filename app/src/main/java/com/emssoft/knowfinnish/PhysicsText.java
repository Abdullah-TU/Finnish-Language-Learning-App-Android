...
@SuppressLint("NewApi")
public class PhysicsText extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.physicstext);
            ...
            switch (event.getAction()) {
                ...
                case DragEvent.ACTION_DROP:
                    ...
                    if(v.getTag()== dropped.getTag())
                    {
                        ...
                        Toast.makeText(PhysicsText.this, "Try again " , Toast.LENGTH_LONG).show();
                    break;
    ...
    public void reset(View view)
    {
        ...
        option2.setText("Gravitation");
        option3.setText("Light");
        option4.setText("Steam");
        option5.setText("Heat");
